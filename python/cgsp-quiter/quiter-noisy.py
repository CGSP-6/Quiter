...
def print_html():
    ...
    temp = env.get_template('quiter-noisy.html')
    inpFol = foliumMap()
...
# c.execute("select LAT_Y,LON_X from ancient_castles")# this help us to select something form the database so I need to create
